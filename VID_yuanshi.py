...
def parse_args():
    ...
    parser.add_argument('--checkpoint_path', type=str,
                        default='/home/data/ztcode/Time-LLM-main/scripts/checkpoints/llama2_1050_1050/checkpoint',
                        help='Checkpoint file path')

    # Dataset parameters
    parser.add_argument('--data', type=str, default='Spectral', help='Dataset type')
    parser.add_argument('--root_path', type=str, default='/home/data/ztcode/Time-LLM-main/dataset/spectral/',
    ...
    parser.add_argument('--save_dir', type=str, default='/home/data/ztcode/Time-LLM-main/visual_enhanced',
...
def setup_model(args):
    ...
    try:
        ...
        if os.path.exists(checkpoint_path):
            ...
            dir_to_check = '/home/data/ztcode/Time-LLM-main/scripts/checkpoints/'
...
def predict(model, test_loader, args, device='cpu'):
    ...
    with torch.no_grad():
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
            ...
            # Only collect specified number of samples
...
def create_enhanced_visualizations(preds, trues, wavelengths_y, args, history_data=None, history_wavelengths=None):
    ...
    # Sample spectra comparison (top row)
    for i in range(3):
