...
/home/user/miniconda3/envs/time-llm311/bin/python VID_test_new.py \
  ...
  --save_dir /home/user/WangS/Time-LLM-main/visual_llama2_2_1_custom \
  --features S \
  --num_samples 10
...
echo "========================================================================"
echo "生成的可视化文件保存在: /home/user/WangS/Time-LLM-main/visual_llama2_2_1_custom/"
echo "显示的样本: R² 值最高的前6个样本（2行×3列）"
echo "========================================================================"
