...
class MIMIC_IV_ECG_Dataset(Dataset):
    def __init__(self,
        ...
        # with open('E:\DiffuSETS_Exp-master\ECGToolkit-master\exclude.txt', 'r') as f:
        ...
        if demo_label:
            ...
            patient_table_path = '/prerequisites/patients.csv'
    ...
    def __getitem__(self, idx: int):
        ...
        item_path = r"E:\DiffuSETS_Exp-master\prerequisites\40689238"
...
class DictDataset(Dataset):
    def __init__(self, path:str):
        self.data_dict = torch.load(path,weights_only=False)
