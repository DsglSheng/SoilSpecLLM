...
parser.add_argument('--wavelength_range', type=int, nargs=2, help='min and max wavelengths')
...
parser.add_argument('--llm_model', type=str, default='LLAMA', help='LLM model')  # LLAMA, GPT2, BERT, BGE-M3, T5
parser.add_argument('--llm_dim', type=int, default='4096',
                    help='LLM model dimension')  # LLama7b:4096; GPT2-small:768; BERT-base:768; BGE-M3:1024; T5-base:768
...
deepspeed_plugin = DeepSpeedPlugin(hf_ds_config='/home/user/WangS/Time-LLM-main/ds_config_zero2.json')
